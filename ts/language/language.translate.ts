 ...
 */
export function GameTranslate(messageCode: string, ...args: any) {
    if (!messageCode) return "UndefinedMessageCode";

    switch (CONFIG_CONSTANTS.LANGUAGE.toLocaleLowerCase()) {
        case "fr":
...
GameTranslate.toEN = function (m: string, a: any[]) {
    switch (m) {
...
GameTranslate.toFR = function (m: string, a: any[]) {
    switch (m) {
