 ...
 * @param {import("../../game").scope} scope The position of the sound folder from the file that call this function.
 ...
 * @file C:\Program Files (x86)\Steam\steamapps\common\The Last Sovereign
 */
